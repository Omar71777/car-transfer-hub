    ...
    <Card className="glass-card shine-effect h-full">
      <CardHeader className="pb-2">
        <div className="flex justify-between items-center">
          <CardTitle className="text-lg text-electric">{name}</CardTitle>
          <div className="h-8 w-8 rounded-full bg-aqua-light flex items-center justify-center">
      ...
      <CardContent>
        <div className="space-y-4">
          ...
          <div className="flex justify-between items-center">
            ...
            <span className="font-medium text-sand-dark">{formatCurrency(commissionTotal)}</span>
          </div>
