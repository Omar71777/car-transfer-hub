...
export const SidebarUserProfile: React.FC<SidebarUserProfileProps> = ({
  ...
  return (
    <div className="relative px-4 py-4 flex items-center group sidebar-profile overflow-hidden">
      ...
      <Avatar className="h-10 w-10 mr-3 ring-2 ring-sidebar-primary/30 bg-gradient-to-br from-sidebar-primary to-sidebar-accent/80">
        <AvatarFallback className="text-white font-medium bg-gradient-to-br from-sidebar-primary to-sidebar-accent/80">
          {getInitials()}
        </AvatarFallback>
      </Avatar>
      
      <div className="flex flex-col justify-center overflow-hidden flex-1">
        <p className="text-sm font-medium truncate text-white group-hover:text-white transition-colors duration-300">
          {fullName()}
        </p>
        <div className="flex items-center text-xs text-white/70 group-hover:text-white/90 transition-colors duration-300">
          <Mail className="h-3 w-3 mr-1 inline-block text-white/70" />
